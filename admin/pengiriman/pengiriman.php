                ...
                <div class="biolife-title-box">
                    ...
                    <br>
                        <table class="striped">
                            ...
                            $order = mysqli_query($koneksi, "SELECT * FROM tbl_pengiriman JOIN tbl_transaksi ON tbl_pengiriman.id_order=tbl_transaksi.id_order ORDER BY id_pengiriman DESC limit $halaman_awal, $batas");
                            ...
                            while($data_order=mysqli_fetch_array($order)){
                                ...
                                if($data_order['status']==1) {
                                    ...
                                    $status ="<a href='index.php?page=pesanan_diterima&id=".$data_order['id_order']."' class='btn btn-primary'>Pesanan Telah Dikirim</a>";
                            ...
                            ?>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        <li class="page-item">
                                            <a class="page-link" <?php if($halaman > 1){ echo "href='?page=pengiriman&halaman=$previous'"; } ?> ><span aria-hidden="true">&laquo;</span> Previous</a>                                                    
                                            
                                        </li>
                                        <?php 
                                            for($x=1;$x<=$total_halaman;$x++){
                                                ?> 
                                                <li class="page-item"><a class="page-link" href="?page=pengiriman&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                                                <?php
                                            }
                                        ?>	
                                    <li class="page-item">
                                        <a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='?page=pengiriman&halaman=$next'"; } ?>>Next <span aria-hidden="true">&raquo;</span></a>                                            
                                    </li>
                                    </ul>
                                </nav>

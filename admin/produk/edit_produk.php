...
if(isset($_POST['simpan'])) {
    ...
    $query_add = mysqli_query($koneksi, "UPDATE tbl_produk SET nama_produk='$nama_produk', id_kategori='$id_kategori', berat='$berat', harga='$harga',stok='$stok',gambar='$foto', diskon='$diskon', deskripsi='$deskripsi', status_pemesanan='$status_pemesanan' WHERE kd_produk='$kd_produk'");

                        ...
                        <div class="signin-container">
                            <form action="" name="frm-login" method="post" enctype="multipart/form-data">
                                <p class="form-row">
                                    ...
                                    <input type="text" id="fid-name" name="kd_produk" class="txt-input" value="<?=$id_konsumen_last?>">
                                </p>
                                <p class="form-row">
                                ...
                                <p class="form-row">
                                    <label for="fid-name">Area Penjualan: <span class="requite">*</span></label>
                                    <select name="status_pemesanan" required>
                                        <option value=""> -- Pilih Area Penjualan --</option>
                                        <option value="0"> Umum </option>
                                        <option value="1"> Khusus (Desa Bojong) </option>
                                    </select>
                                </p>
                                <br><br>
...
if(isset($_POST['simpan'])) {
    ...
    if($terupload) {
	    ...
	    $query_add = mysqli_query($koneksi, "INSERT into tbl_produk (kd_produk, id_kategori, nama_produk, deskripsi, berat, harga, stok, gambar, diskon, status, status_pemesanan) VALUES ('$kd_produk','$id_kategori','$nama_produk','$deskripsi','$berat','$harga','$stok','$namaFile','$diskon',0,'$status_pemesanan')");

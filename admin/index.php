                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                ...
                                <li class="menu-item"><a href="index.php?page=pengiriman">Pengiriman</a></li>
                                <li class="menu-item"><a href="index.php?page=users">Pengguna</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-md-6 col-xs-6">
                        <div class="biolife-cart-info">
                            ...
                            <div class="wishlist-block hidden-sm hidden-xs">
                                <a href="index.php?page=reward" class="link-to">
                            ...
                            <div class="wishlist-block hidden-sm hidden-xs">
                                <a href="index.php?page=pengiriman" class="link-to">
                                    <span class="icon-qty-combine">
                                        <i class="icon-car biolife-icon"></i>
                                        <span class="qty"><?=$hit_pengiriman?></span>
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="minicart-block">
                                <div class="minicart-contain">
                                    <a href="index.php?page=transaksi" class="link-to">
                                            <span class="icon-qty-combine">
                                                <i class="icon-cart-mini biolife-icon"></i>
                                                <span class="qty"><?=$hit_pesanan?></span>
                                            </span>
                                        <span class="title">Orderan Masuk</span>
                                    </a>
                                </div>
                            </div>
                        </div>

                       ...
                       <div class="signin-container">
                            <form action="" name="frm-login" method="post">
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="text" id="fid-name" name="nama_kategori" class="txt-input" value="<?=$data_pelanggan['poin']?>" readonly>
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Voucher Poin :<span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="nama_kategori" class="txt-input" value="<?=rupiah($data_pelanggan['nominal_poin'])?>" readonly>
                                </p>
                                <p class="form-row">

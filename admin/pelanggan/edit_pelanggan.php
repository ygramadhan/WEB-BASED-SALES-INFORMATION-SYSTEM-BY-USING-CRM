                    ...
                    <div class="intro">
                       ...
                       <div class="signin-container">
                            <form action="" name="frm-login" method="post">
                                ...
                                <p class="form-row">
                                    <label for="fid-name">Poin :<span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="poin" class="txt-input" value="<?=$data_pelanggan['poin']?>" required>
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Voucher Poin :<span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="nominal_poin" class="txt-input" value="<?=$data_pelanggan['nominal_poin']?>" required>
                                </p>
                                <p class="form-row">
...
if(isset($_POST['edit'])) {
    ...
    $poin = $_POST['poin'];
    $nominal_poin = $_POST['nominal_poin'];

    $ubah = mysqli_query($koneksi, "UPDATE tbl_pelanggan SET nama_pelanggan='$nama_pelanggan', jk='$jk', tgl_lahir='$tgl_lahir', alamat='$alamat',telp='$telp',email='$email', poin='$poin', nominal_poin='$nominal_poin', username='$username', password='$password' WHERE id_pelanggan='$id_pelanggan' ");

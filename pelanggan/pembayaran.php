    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">Pembayaran</span></li>
            </ul>
        </nav>
    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                                ...
                                $id = $_GET['id'];
                                    ...
                                    $pelanggan = mysqli_query($koneksi,"SELECT * FROM tbl_pelanggan JOIN tbl_wilayah ON tbl_pelanggan.id_wilayah=tbl_wilayah.id_wilayah WHERE id_pelanggan='$_SESSION[id_pelanggan]'");
                                ...
                                <table>
                                    ...
                                    <tr class="cart_item wrap-buttons">
                                        ...
                                        <td class="wrap-btn-control" colspan="4">
                                            <button type="submit" class="btn back-to-shop" name="bayar">Bayar Sekarang</button>
                                        </td>
                                    </tr>

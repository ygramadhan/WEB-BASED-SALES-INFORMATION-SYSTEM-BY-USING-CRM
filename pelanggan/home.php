<div class="page-contain"
    <div id="main-content" class="main-content">
            ...
            <div class="main-slide block-slider">
                <ul class="biolife-carousel nav-none-on-mobile" data-slick='{"arrows": true, "dots": false, "slidesMargin": 0, "slidesToShow": 1, "infinite": true, "speed": 800}' >
                    ...
                    <li>
                        <div class="slide-contain slider-opt03__layout01">
                            <div class="media">
                                <div class="child-elememt"><img src="../assets/images/slide-02.png" width="604" height="580" alt=""></div>
                            </div>
                            <div class="text-content">
            ...
            <div class="special-slide">
                    <div class="biolife-service type01 biolife-service__type01 sm-margin-top-0 xs-margin-top-45px">
                        ...
                        <i class="txt-show-02">Produk Teratas</i>
                    </div>
                            ...
                            <div class="slide-contain biolife-banner__special">
                                <div class="banner-contain">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <span class="third-line"><?=$data_produk_terpilih['deskripsi']?></span>
            ...
            <div class="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px" id="produk">
                <div class="container">
                                        ...
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="index.php?page=detail_produk&id=<?=$data_produk['kd_produk']?>" class="link-to-product">
                                                    <img src="../admin/produk/pict/<?=$data_produk['gambar']?>" alt="Vegetables" width="370" height="370" class="product-thumnail">
                                                </a>
                                            ...
                                            <div class="info">
                                                ...
                                                <?=$ket?>
                                                <h4 class="product-title"><a href="#" class="pr-name"><?=$data_produk['nama_produk']?></a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><?=$harga?></span></ins>
                                                    <del><span class="price-amount"><?=$harga_coret?></span></del>
                                                </div>
	...
	<section class="location">
		<div class="container">
			  <div class="biolife-title-box">
                       <h3 class="main-title">Lokasi Depot Air Minum Barokah</h3>
                    </div><br><br>
